...
class ConstantsTests: XCTestCase {
    ...
    func testPlanet2PlanetaryObjectType() {
        XCTAssertTrue(KPCPlanetaryObject.fromPlanet(KPCAAPlanetMercury).objectType! is SwiftAstronomy.Mercury.Type)
        XCTAssertTrue(KPCPlanetaryObject.fromPlanet(KPCAAPlanetVenus).objectType! is SwiftAstronomy.Venus.Type)
        XCTAssertTrue(KPCPlanetaryObject.fromPlanet(KPCAAPlanetEarth).objectType == nil)
        XCTAssertTrue(KPCPlanetaryObject.fromPlanet(KPCAAPlanetMars).objectType! is SwiftAstronomy.Mars.Type)
        XCTAssertTrue(KPCPlanetaryObject.fromPlanet(KPCAAPlanetJupiter).objectType! is SwiftAstronomy.Jupiter.Type)
        XCTAssertTrue(KPCPlanetaryObject.fromPlanet(KPCAAPlanetSaturn).objectType! is SwiftAstronomy.Saturn.Type)
        XCTAssertTrue(KPCPlanetaryObject.fromPlanet(KPCAAPlanetNeptune).objectType! is SwiftAstronomy.Neptune.Type)
        XCTAssertTrue(KPCPlanetaryObject.fromPlanet(KPCAAPlanetUranus).objectType! is SwiftAstronomy.Uranus.Type)
